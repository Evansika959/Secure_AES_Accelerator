...
#  Updated by Hyochan An, Qirui Zhang, Ming-Hung Chen,  #
#  Andrea Bejarano                                      #
#  Innvous Input configuration file            			#
#########################################################

set my_toplevel encrypt_engine
...
create_rc_corner -name typical_rc_corner \
	-qx_tech_file		/afs/umich.edu/class/eecs627/w25/resources/cmos8rf_8LM_62_SigCmax.tch \
	-preRoute_res		1 \
	-postRoute_res		1 \
	-preRoute_cap		1 \
	-postRoute_cap		1 \
